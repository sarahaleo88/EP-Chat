            ...
            <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-500 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
                  基于 DeepSeek 的智能对话助手，帮助您生成高质量的提示词，提升 AI 交互体验
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto mb-16">
                {[
                  ...
                  },
                  {
                    ...
                    bgColor: 'group-hover:bg-orange-50 dark:group-hover:bg-orange-900/20',
                  ...
                  },
                  {
                    ...
                    bgColor: 'group-hover:bg-shamrock-50 dark:group-hover:bg-shamrock-900/20',
                  ...
                  >
                    ...
                    <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:translate-x-1">
                      <svg className="w-6 h-6 text-shamrock-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center space-y-6">
                <div className="inline-flex items-center space-x-3 px-6 py-3 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-200 dark:border-gray-700 shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">AI 已就绪</span>
                  </div>
                  <div className="w-px h-4 bg-gray-300 dark:bg-gray-600"></div>
                  <span className="text-sm text-gray-500 dark:text-gray-400">支持中英文对话</span>
                  <div className="w-px h-4 bg-gray-300 dark:bg-gray-600"></div>
                  <span className="text-sm text-gray-500 dark:text-gray-400">实时响应</span>
                </div>
      ...
      <div className="border-t border-gray-200/50 dark:border-gray-700/50 bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl px-4 py-4 shadow-2xl">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mt-3 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div>
              <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Enter</kbd> 发送
              <span className="mx-2">•</span>
              <kbd className="px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-xs">Shift + Enter</kbd> 换行
            </div>
          </div>
        </div>
      </div>
