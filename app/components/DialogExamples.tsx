  ...
  return (
    <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          ...
          >
            <div className="w-8 h-8 bg-clover-100 dark:bg-clover-900/20 rounded-lg flex items-center justify-center mb-3">
              <svg
                className="w-4 h-4 text-clover-600 dark:text-clover-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="bg-clover-50 dark:bg-clover-900/20 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-clover-700 dark:text-clover-300">
            <li className="flex items-start space-x-2">
              ...
              <span>
                <strong>Dialog:</strong> 居中模态框，适合重要信息展示
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="w-1.5 h-1.5 bg-clover-500 rounded-full mt-2 flex-shrink-0"></span>
              <span>
                <strong>SlideOver:</strong> 侧边滑出，不干扰主内容滚动
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="w-1.5 h-1.5 bg-clover-500 rounded-full mt-2 flex-shrink-0"></span>
              <span>
                <strong>BottomSheet:</strong> 移动端优化，支持手势操作
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="w-1.5 h-1.5 bg-clover-500 rounded-full mt-2 flex-shrink-0"></span>
      ...
      <SlideOver
        ...
        size="lg"
      >
        <SlideOverHeader title="详细信息" subtitle="查看和编辑项目详情" />
        <SlideOverBody>
