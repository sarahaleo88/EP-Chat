...
| T-P1-05 | lib/prometheus-metrics.ts | Prometheus 指标收集 | Unit | Vitest | P1 | TODO |
...
| T-P1-11 | app/components/WindowStyleChat.tsx | 主聊天界面组件 | Unit | Vitest+RTL | P1 | TODO |
| T-P1-12 | app/hooks/useModelState.ts | 模型状态 Hook | Unit | Vitest+RTL | P1 | TODO |
| T-P1-13 | app/components/ModelSelector.tsx | 模型选择器组件 | Unit | Vitest+RTL | P1 | TODO |
| T-P1-14 | app/components/PromptInput.tsx | 提示输入组件 | Unit | Vitest+RTL | P1 | TODO |
| T-P1-15 | app/components/PromptOutput.tsx | 提示输出组件 | Unit | Vitest+RTL | P1 | TODO |
...
| ID | Module | Responsibility | Type | Framework | Priority | Status |
|----|--------|---------------|------|-----------|----------|--------|
| T-P2-01 | app/components/ErrorBoundary.tsx | 错误边界处理 | Unit | Vitest+RTL | P2 | TODO |
| T-P2-02 | app/components/LoadingSpinner.tsx | 加载指示器 | Unit | Vitest+RTL | P2 | TODO |
| T-P2-03 | app/api/health/route.ts | 健康检查 API | Integration | Vitest | P2 | TODO |
| T-P2-04 | app/api/metrics/route.ts | 指标收集 API | Integration | Vitest | P2 | TODO |
| T-P2-05 | app/api/security-metrics/route.ts | 安全指标 API | Integration | Vitest | P2 | TODO |
| T-P2-06 | lib/performance-middleware.ts | 性能中间件 | Unit | Vitest | P2 | TODO |
| T-P2-07 | lib/performance-optimizer.ts | 性能优化器 | Unit | Vitest | P2 | TODO |
| T-P2-08 | lib/performance-utils.ts | 性能工具函数 | Unit | Vitest | P2 | TODO |
| T-P2-09 | lib/performance-evaluator.ts | 性能评估器 | Unit | Vitest | P2 | TODO |
| T-P2-10 | lib/accessibility-utils.ts | 无障碍工具 | Unit | Vitest | P2 | TODO |
| T-P2-11 | lib/comprehension-testing.ts | 理解测试工具 | Unit | Vitest | P2 | TODO |
| T-P2-12 | app/components/TemplateSelector.tsx | 模板选择器 | Unit | Vitest+RTL | P2 | TODO |
| T-P2-13 | app/components/CSPNonceProvider.tsx | CSP Nonce Provider | Unit | Vitest+RTL | P2 | TODO |
| T-P2-14 | app/api/csrf-token/route.ts | CSRF Token API | Integration | Vitest | P2 | TODO |
...
*最后更新：2025-12-02 - P0 全部完成，P1 完成 9/15*
